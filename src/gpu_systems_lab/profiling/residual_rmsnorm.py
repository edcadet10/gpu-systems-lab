...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    parser.add_argument("--provider", choices=("torch", "triton"), default="triton")
    ...
    function = residual_rmsnorm_triton if args.provider == "triton" else residual_rmsnorm_reference
